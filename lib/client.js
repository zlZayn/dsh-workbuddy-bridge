window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = "._1kHyqG_page{flex-direction:column;gap:16px;display:flex}._1kHyqG_fieldRow{border-top:.5px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:12px 0;display:flex}._1kHyqG_fieldText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}._1kHyqG_fieldLabel{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:1.5}._1kHyqG_body{flex-direction:column;padding:4px 0 12px;display:flex}._1kHyqG_section{flex-direction:column;gap:6px;padding:12px 0;display:flex}._1kHyqG_section+._1kHyqG_section{border-top:.5px solid var(--dsw-alias-border-l2)}._1kHyqG_title{color:var(--dsw-alias-label-primary);margin:0;font-size:13px;font-weight:500;line-height:1.5}._1kHyqG_row{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:8px;display:flex}._1kHyqG_accountRow{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;font-size:13px;font-weight:500;line-height:1.5;display:flex}._1kHyqG_text{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px;line-height:1.5}._1kHyqG_dim{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}._1kHyqG_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px;line-height:1.5}._1kHyqG_package{flex-direction:column;gap:8px;display:flex}._1kHyqG_packageLabel{color:var(--dsw-alias-label-secondary);justify-content:space-between;gap:8px;font-size:13px;line-height:1.5;display:flex}._1kHyqG_track{corner-shape:round;background:var(--dsw-alias-border-l3);border-radius:999px;height:8px;overflow:hidden}._1kHyqG_fill{border-radius:inherit;background:var(--dsw-alias-brand-primary);height:100%}._1kHyqG_modelRow{justify-content:space-between;align-items:flex-start;gap:8px;display:flex}._1kHyqG_modelMain{align-items:center;gap:8px;min-width:0;display:flex}._1kHyqG_modelStack{flex-direction:column;gap:2px;min-width:0;display:flex}._1kHyqG_modelEnd{text-align:right;flex-direction:column;gap:2px;display:flex}._1kHyqG_badges{flex-wrap:wrap;align-items:center;gap:6px;display:flex}._1kHyqG_confirm{border:.5px solid var(--dsw-alias-border-l2);border-radius:var(--dsw-radius-md);background:var(--dsw-alias-bg-layer-3);flex-direction:column;gap:8px;padding:10px 12px;display:flex}._1kHyqG_confirmRow{justify-content:flex-end;gap:8px;display:flex}._1kHyqG_probeRow{justify-content:space-between;align-items:center;gap:8px;display:flex}._1kHyqG_probeEnd{flex:none;align-items:center;gap:8px;display:inline-flex}._1kHyqG_assist{border:.5px solid var(--dsw-alias-border-l2);border-radius:var(--dsw-radius-md);background:var(--dsw-alias-bg-module-platform);flex-direction:column;gap:8px;padding:12px;display:flex}._1kHyqG_prompt{min-width:0;color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;user-select:text;flex:220px;margin:0;font-size:12px;line-height:1.6}._1kHyqG_promptRow{border:.5px solid var(--dsw-alias-border-l2);border-radius:var(--dsw-radius-sm);background:var(--dsw-alias-bg-layer-3);flex-wrap:wrap;align-items:flex-start;gap:8px;padding:8px 9px 8px 11px;display:flex}";
		...
		var workbuddy_module_css_default = {
			...
			"dim": "_1kHyqG_dim",
			"error": "_1kHyqG_error",
			"fieldLabel": "_1kHyqG_fieldLabel",
			"fieldRow": "_1kHyqG_fieldRow",
			"fieldText": "_1kHyqG_fieldText",
			"fill": "_1kHyqG_fill",
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.SettingsForm, {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: workbuddy_module_css_default.fieldRow,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									className: workbuddy_module_css_default.fieldText,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: workbuddy_module_css_default.fieldLabel,
										children: t("probeConsent")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: workbuddy_module_css_default.dim,
										children: t("probeConsentHint")
									})]
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: workbuddy_module_css_default.fieldLabel,
										children: t("maximumContextWindow")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: workbuddy_module_css_default.dim,
