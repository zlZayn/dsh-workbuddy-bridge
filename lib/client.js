window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0workbuddy-css:/workspace/dsh-workbuddy-connect/src/client/workbuddy.module.css.js
		const css$1 = ".Nbq4Cq_body{flex-direction:column;gap:14px;padding-top:4px;display:flex}.Nbq4Cq_section{flex-direction:column;gap:10px;display:flex}.Nbq4Cq_title{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;font-weight:600;line-height:20px}.Nbq4Cq_row{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;display:flex}.Nbq4Cq_accountRow{color:var(--dsw-alias-label-primary);align-items:center;gap:9px;font-size:15px;font-weight:500;display:flex}.Nbq4Cq_text{color:var(--dsw-alias-label-secondary);margin:0;font-size:14px;line-height:22px}.Nbq4Cq_dim{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px;line-height:18px}.Nbq4Cq_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:13px;line-height:20px}.Nbq4Cq_package{flex-direction:column;gap:8px;display:flex}.Nbq4Cq_packageLabel{color:var(--dsw-alias-label-secondary);justify-content:space-between;gap:12px;font-size:13px;line-height:20px;display:flex}.Nbq4Cq_track{background:var(--dsw-alias-bg-layer-2,#00000014);border-radius:999px;height:8px;overflow:hidden}.Nbq4Cq_fill{border-radius:inherit;background:var(--dsw-alias-brand-primary,#1677ff);height:100%}.Nbq4Cq_modelRow{justify-content:space-between;align-items:flex-start;gap:12px;display:flex}.Nbq4Cq_modelMain{align-items:center;gap:9px;min-width:0;display:flex}.Nbq4Cq_modelStack{flex-direction:column;gap:2px;min-width:0;display:flex}.Nbq4Cq_modelEnd{text-align:right;flex-direction:column;gap:2px;display:flex}.Nbq4Cq_badges{flex-wrap:wrap;align-items:center;gap:6px;display:flex}.Nbq4Cq_confirm{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex-direction:column;gap:10px;padding:10px 12px;display:flex}.Nbq4Cq_confirmRow{justify-content:flex-end;gap:8px;display:flex}.Nbq4Cq_probeRow{justify-content:space-between;align-items:center;gap:12px;display:flex}.Nbq4Cq_probeEnd{flex:none;align-items:center;gap:8px;display:inline-flex}.Nbq4Cq_assist{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2,#0000000a);border-radius:10px;flex-direction:column;gap:10px;padding:12px 14px;display:flex}.Nbq4Cq_prompt{min-width:0;color:var(--dsw-alias-label-primary);white-space:pre-wrap;overflow-wrap:anywhere;user-select:text;flex:220px;margin:0;font-size:12px;line-height:19px}.Nbq4Cq_promptRow{background:var(--dsw-alias-bg-layer-1);border-radius:7px;flex-wrap:wrap;align-items:flex-start;gap:8px;padding:8px 9px 8px 11px;display:flex}";
		const tagId$1 = "dsh-workbuddy-connect/workbuddy.module.css";
		...
		var workbuddy_module_css_default = {
			"package": "Nbq4Cq_package",
			"packageLabel": "Nbq4Cq_packageLabel",
			"confirm": "Nbq4Cq_confirm",
			"confirmRow": "Nbq4Cq_confirmRow",
			"probeRow": "Nbq4Cq_probeRow",
			"modelRow": "Nbq4Cq_modelRow",
			"prompt": "Nbq4Cq_prompt",
			"promptRow": "Nbq4Cq_promptRow",
			"modelEnd": "Nbq4Cq_modelEnd",
			"text": "Nbq4Cq_text",
			"modelMain": "Nbq4Cq_modelMain",
			"badges": "Nbq4Cq_badges",
			"probeEnd": "Nbq4Cq_probeEnd",
			"title": "Nbq4Cq_title",
			"modelStack": "Nbq4Cq_modelStack",
			"row": "Nbq4Cq_row",
			"fill": "Nbq4Cq_fill",
			"track": "Nbq4Cq_track",
			"assist": "Nbq4Cq_assist",
			"section": "Nbq4Cq_section",
			"body": "Nbq4Cq_body",
			"accountRow": "Nbq4Cq_accountRow",
			"dim": "Nbq4Cq_dim",
			"error": "Nbq4Cq_error"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0workbuddy-css:/workspace/dsh-workbuddy-connect/src/client/probe-control.module.css.js
		const css = ".Z7X_wG_wrapper{align-items:center;margin-right:-8px;display:inline-flex;position:relative;transform:translateY(2px)}.Z7X_wG_trigger{gap:2px}.Z7X_wG_label{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.Z7X_wG_bubble{z-index:1001;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1,#fff);width:260px;box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);border-radius:8px;flex-direction:column;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0}.Z7X_wG_note{z-index:1001;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);white-space:nowrap;border-radius:8px;align-items:center;gap:8px;padding:6px 10px;font-size:12px;line-height:18px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0}";
		const tagId = "dsh-workbuddy-connect/probe-control.module.css";
		...
		var probe_control_module_css_default = {
			"wrapper": "Z7X_wG_wrapper",
			"label": "Z7X_wG_label",
			"bubble": "Z7X_wG_bubble",
			"note": "Z7X_wG_note",
			"trigger": "Z7X_wG_trigger"
		};
		//#endregion
