window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = "._1kHyqG_body{flex-direction:column;gap:14px;padding-top:4px;display:flex}._1kHyqG_section{flex-direction:column;gap:10px;display:flex}._1kHyqG_title{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;font-weight:600;line-height:20px}._1kHyqG_row{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;display:flex}._1kHyqG_accountRow{color:var(--dsw-alias-label-primary);align-items:center;gap:9px;font-size:15px;font-weight:500;display:flex}._1kHyqG_text{color:var(--dsw-alias-label-secondary);margin:0;font-size:14px;line-height:22px}._1kHyqG_dim{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px;line-height:18px}._1kHyqG_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:13px;line-height:20px}._1kHyqG_package{flex-direction:column;gap:8px;display:flex}._1kHyqG_packageLabel{color:var(--dsw-alias-label-secondary);justify-content:space-between;gap:12px;font-size:13px;line-height:20px;display:flex}._1kHyqG_track{background:var(--dsw-alias-bg-layer-2,#00000014);border-radius:999px;height:8px;overflow:hidden}._1kHyqG_fill{border-radius:inherit;background:var(--dsw-alias-brand-primary,#1677ff);height:100%}._1kHyqG_modelRow{justify-content:space-between;align-items:flex-start;gap:12px;display:flex}._1kHyqG_modelMain{align-items:center;gap:9px;min-width:0;display:flex}._1kHyqG_modelStack{flex-direction:column;gap:2px;min-width:0;display:flex}._1kHyqG_modelEnd{text-align:right;flex-direction:column;gap:2px;display:flex}._1kHyqG_badges{flex-wrap:wrap;align-items:center;gap:6px;display:flex}._1kHyqG_confirm{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:8px;flex-direction:column;gap:10px;padding:10px 12px;display:flex}._1kHyqG_confirmRow{justify-content:flex-end;gap:8px;display:flex}._1kHyqG_probeRow{justify-content:space-between;align-items:center;gap:12px;display:flex}._1kHyqG_probeEnd{flex:none;align-items:center;gap:8px;display:inline-flex}._1kHyqG_assist{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2,#0000000a);border-radius:10px;flex-direction:column;gap:10px;padding:12px 14px;display:flex}._1kHyqG_prompt{min-width:0;color:var(--dsw-alias-label-primary);white-space:pre-wrap;overflow-wrap:anywhere;user-select:text;flex:220px;margin:0;font-size:12px;line-height:19px}._1kHyqG_promptRow{background:var(--dsw-alias-bg-layer-1);border-radius:7px;flex-wrap:wrap;align-items:flex-start;gap:8px;padding:8px 9px 8px 11px;display:flex}";
		...
		var workbuddy_module_css_default = {
			"accountRow": "_1kHyqG_accountRow",
			"assist": "_1kHyqG_assist",
			"badges": "_1kHyqG_badges",
			"body": "_1kHyqG_body",
			"confirm": "_1kHyqG_confirm",
			"confirmRow": "_1kHyqG_confirmRow",
			"dim": "_1kHyqG_dim",
			"error": "_1kHyqG_error",
			"fill": "_1kHyqG_fill",
		...
		*/
		...
		const css = ".Ivd5xG_wrapper{align-items:center;display:inline-flex;position:relative}.Ivd5xG_trigger{corner-shape:round;cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex;position:relative}.Ivd5xG_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Ivd5xG_trigger:disabled{cursor:default;color:var(--dsw-alias-label-dimmed)}.Ivd5xG_trigger:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.Ivd5xG_trigger[aria-busy=true] svg{transform-origin:50%;animation:1.2s linear infinite Ivd5xG_wb-probe-spin}@keyframes Ivd5xG_wb-probe-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.Ivd5xG_trigger[aria-busy=true] svg{animation:none}}.Ivd5xG_panel{isolation:isolate;z-index:1100;box-sizing:border-box;--dsw-elevation-stroke-color:var(--dsw-alias-border-l1);width:max-content;min-width:min(280px,100vw - 24px);max-width:min(360px,100vw - 24px);box-shadow:var(--dsw-elevation-prominent);color:var(--dsw-alias-label-secondary);cursor:default;border:0;border-radius:12px;padding:12px;font-size:12px;line-height:18px;position:fixed}.Ivd5xG_panel:before{z-index:-1;border-radius:inherit;background:var(--dsw-specific-menu);backdrop-filter:var(--dsw-menu-backdrop-filter);content:\"\";pointer-events:none;position:absolute;inset:0}.Ivd5xG_panelTitle{color:var(--dsw-alias-label-primary);align-items:center;gap:6px;font-weight:500;display:flex}.Ivd5xG_panelTitleIcon{color:var(--dsw-alias-label-secondary);flex:none;align-items:center;display:inline-flex}.Ivd5xG_panelTitleText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Ivd5xG_iconButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;margin-left:auto;padding:0;display:inline-flex;position:relative}.Ivd5xG_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Ivd5xG_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.Ivd5xG_titleRule{border-top:.5px solid var(--dsw-alias-border-l2);margin:8px 0 10px}.Ivd5xG_body{color:var(--dsw-alias-label-secondary);margin:0}.Ivd5xG_panelActions{justify-content:flex-end;gap:8px;margin-top:12px;display:flex}";
		...
		*/
		...
		function ModelProbe({ model, card, t }) {
			...
			*/
			...
			const open = confirming || note !== void 0;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: probe_control_module_css_default.iconButton,
						...
						confirming ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							className: probe_control_module_css_default.body,
							children: t("probeBubbleBody")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							role: "status",
							"aria-live": "polite",
							children: note === void 0 ? "" : noteText(t, note)
						})
					]
				}), document.body) : null]
			});
