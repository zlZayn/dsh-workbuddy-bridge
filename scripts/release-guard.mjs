...
const NON_ARTIFACT_PREFIXES = ['docs/', 'tests/', '.github/', '.agents/', 'assets/'];
/** 工具类脚本：不参与构建产物，改它们不影响 npm 上的包。 */
const NON_ARTIFACT_SCRIPTS = new Set(['scripts/release-guard.mjs']);
...
function isNonArtifact(file) {
  if (file.startsWith('.local/')) return true; // 本机工具资产，永不入库
